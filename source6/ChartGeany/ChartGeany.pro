...
#
# distribution
win32:DISTRIBUTION = $$system(systeminfo|c:\windows\system32\findstr.exe /B /C:\"OS Name\")
...
#
# common gcc flags
*g++:QMAKE_CFLAGS += -fmax-errors=2 -fstrict-aliasing -fexceptions -O2 
*g++:QMAKE_CXXFLAGS += -fmax-errors=2 -fstrict-aliasing -fexceptions -fconstexpr-depth=4096 -O2 -Wno-deprecated-declarations
...
*g++*:QMAKE_CXXFLAGS += -Wno-class-memaccess
...
#
# common clang flags
*clang:QMAKE_CFLAGS += -fstrict-aliasing -fexceptions -std=c99
*clang:QMAKE_CXXFLAGS += -fstrict-aliasing -fexceptions -Wall -Wextra -std=c++11
*clang:QMAKE_CXXFLAGS += -Wno-deprecated-declarations

# solaris flags for all compilers
solaris* {
...
msvc:QMAKE_CFLAGS_RELEASE += /UDEBUG /MP -D_CRT_SECURE_NO_WARNINGS -DTCC_TARGET_PE
msvc:QMAKE_CXXFLAGS_RELEASE += /UDEBUG /MP -D_CRT_SECURE_NO_WARNINGS 

!contains(QMAKE_TARGET.arch, x86_64) {
      LIBS += -L../../binaries/msvc32/lib -llibeay32
      INCLUDEPATH += ../binaries/msvc32/include
    } else {
      LIBS += -L../../binaries/msvc64/lib -llibssl
...
QMAKE_CFLAGS += -fomit-frame-pointer -w -D$$TCC_ARCH -fstack-protector
...
QMAKE_CFLAGS     += -w -fomit-frame-pointer -fstack-protector
QMAKE_CXXFLAGS   += -D_XOPEN_SOURCE -fomit-frame-pointer -fstack-protector
QMAKE_INFO_PLIST += default.plist
QMAKE_POST_LINK  += strip $(TARGET) &&
QMAKE_POST_LINK  += /bin/cp ../cgtool/cgtool ./$${TARGET}.app/Contents/MacOS &&
QMAKE_POST_LINK  += /bin/cp -R ../ChartGeany/licenses ./$${TARGET}.app &&
...
# QMAKE_CFLAGS += -fno-omit-frame-pointer -ggdb -O0 -DDEBUG 
# QMAKE_CXXFLAGS += -fno-omit-frame-pointer -ggdb -O0 -DDEBUG
...
#
# sanitize undefined
# QMAKE_LFLAGS += -fsanitize=undefined -O0
# QMAKE_CFLAGS_RELEASE += -ggdb -fsanitize=undefined -O0 -g
...
#
# QWebEngineView: available after Qt 5.4
equals(QT_MAJOR_VERSION, 5) {
...
linux*|win32*|solaris* {
INCLUDEPATH += \
        3rdparty/libtcc/include \
        3rdparty/libtcc/i386 \
        3rdparty/libtcc/x86_64

SOURCES += \
        3rdparty/libtcc/src/tccasm.c \
        3rdparty/libtcc/src/tccelf.c \
        3rdparty/libtcc/src/tccgen.c \
        3rdparty/libtcc/src/tccpp.c \
        3rdparty/libtcc/src/tccrun.c \
        3rdparty/libtcc/src/libtcc.c
}

#
# libxls
solaris*|macx*|win32*|contains(OSDISTRO, .*Debian.*)|contains(OSDISTRO, .*centos.*)|contains(OSDISTRO, .*Ubuntu.*)|equals(XPACKAGER, "FLATPAK") {
INCLUDEPATH += \
