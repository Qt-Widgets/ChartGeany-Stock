...
QTACastFromConstVoid (const void *ptr)
{
  ...
  if (obj->metaObject()->className() == CGLiteral ("QTACObject"))
...
extern Q_DECL_EXPORT int printf_imp (const char *str, va_list ap) FORMAT;
...
extern Q_DECL_EXPORT int ChartWidth_imp (const void *ptr) Q_DECL_NOEXCEPT;

/* ChartHeight implementation */
extern Q_DECL_EXPORT int ChartHeight_imp (const void *ptr) Q_DECL_NOEXCEPT;

/* ChartForeColor */
extern Q_DECL_EXPORT Color_t ChartForeColor_imp (const void *ptr) Q_DECL_NOEXCEPT;

/* ChartBackColor */
extern Q_DECL_EXPORT Color_t ChartBackColor_imp (const void *ptr) Q_DECL_NOEXCEPT;

/* CurrentTF */
extern Q_DECL_EXPORT TimeFrame_t ChartCurrentTF_imp (const void *ptr) Q_DECL_NOEXCEPT;

/* CurrentBar */
extern Q_DECL_EXPORT int ChartCurrentBar_imp (const void *ptr) Q_DECL_NOEXCEPT;
...
extern Q_DECL_EXPORT int NewestVisibleBar_imp (const void *ptr) Q_DECL_NOEXCEPT;

/* OldestVisibleBar implementation */
extern Q_DECL_EXPORT int OldestVisibleBar_imp (const void *ptr) Q_DECL_NOEXCEPT;
