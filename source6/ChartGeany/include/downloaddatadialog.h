...
private:
  ...
  /// Twelve data related functions
  void downloadTwelveDataControl (void);         // control data download from twelve data
  void checkTwelveDatasymbolExistence (void);    // check if symbol exists

  /// Alpha Vantage functions
  void downloadAlphaVantageControl (void);        // control data download from alpha vantage
