...
public:
  ...
  void setFeed (QString text);                 // set data feed
  void setCurrency (QString text);         // set currency
private:
  QString feed;                         // data feed
  QString currency;                     // portfolio currency
...
public:
  ...
  inline QString title () const Q_DECL_NOEXCEPT
  {
    return ptitle;
  };                        // returns portfolio's title
  inline int id () const Q_DECL_NOEXCEPT
  {
    return pf_id;
  ...
  void    setCurrency (QString text)            // sets portfolio's currency
  {
    currency = text;
    ptotals->setCurrency (text);
  };                       
...
private:
  ...
  QStringList trcheadersList,   // list of columns' headers for transactions
              ...
              colheaderList;    // list of columns' headers for properties 
