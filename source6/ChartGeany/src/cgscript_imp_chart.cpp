...
ChartWidth_imp (const void *ptr) Q_DECL_NOEXCEPT
{
...
// ChartHeight
extern "C" Q_DECL_EXPORT int
ChartHeight_imp (const void *ptr) Q_DECL_NOEXCEPT
{
  const QTAChartCore *core = static_cast <const QTAChartCore *> (ptr);
...
ChartForeColor_imp (const void *ptr) Q_DECL_NOEXCEPT
{
  const QTAChartCore *core = static_cast <const QTAChartCore *> (ptr);
...
// ChartBackColor
extern "C" Q_DECL_EXPORT Color_t
ChartBackColor_imp (const void *ptr) Q_DECL_NOEXCEPT
{
  const QTAChartCore *core = static_cast <const QTAChartCore *> (ptr);
...
ChartCurrentTF_imp (const void *ptr) Q_DECL_NOEXCEPT
{
  const QTAChartCore *core = static_cast <const QTAChartCore *> (ptr);
...
// ChartCurrentBar
extern "C" Q_DECL_EXPORT int
ChartCurrentBar_imp (const void *ptr) Q_DECL_NOEXCEPT
{
  const QTAChartCore *core = static_cast <const QTAChartCore *> (ptr);
