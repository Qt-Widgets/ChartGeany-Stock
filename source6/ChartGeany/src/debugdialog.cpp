  ...
  QDialog (parent), ui (new Ui::DebugDialog)
{
  ...
  setStyleSheet (CGLiteral ("background: transparent; background-color:lightgray;"));
  ui->debugPlainTextEdit->
  setStyleSheet (CGLiteral ("QMenu{background: transparent; background-color:lightgray;selection-background-color: blue; border: 1px solid black;}"));
...
DebugDialog::clearButton_clicked (void)
{
  ...
  (CGLiteral ("<p><b><h3>CGScript version ") % QString (_CGSCRIPT_VERSION_STR) % CGLiteral (" </h2></b></p>"));
  appendText ("");
}
