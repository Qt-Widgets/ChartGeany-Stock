  ...
  QWidget (parent), ui (new Ui::EditorWidget)
{
  ...
  file.setFileName (CGLiteral (":/source/cgscript/include/newscript.h"));
#ifdef DEBUG
#ifdef Q_OS_LINUX
  file.setFileName (CGLiteral ("ChartGeany/cgscript/include/newscript.h"));
#endif // Q_OS_LINUX
#endif // DEBUG
...
EditorWidget::openButton_clicked (void)
{
  ...
  if (fname == fileName || fileName.isEmpty ())
  {
    QFile file(fname);
