...
void
QTCGraphicsItem::QTCGraphicsItem_constructor_common ()
{
  Scene = nullptr;
  initialized = false;
...
void
QTCGraphicsItem::setRect (const qreal x, const qreal y, 
...
// setZValue
void
QTCGraphicsItem::setZValue (const qreal z)
{
  switch (type)
  {
  case LineItem:
...
// setOpacity
void
QTCGraphicsItem::setOpacity (const qreal z)
{
  switch (type)
  {
  case LineItem:
...
void
QTCGraphicsItem::setPos (const qreal x, const qreal y)
{
  switch (type)
  {
  case LineItem:
...
// setVisible
void
QTCGraphicsItem::setVisible (const bool visible)
{
  switch (type)
  {
  case LineItem:
...
// setSize
void
QTCGraphicsItem::setSize (const qreal x, const qreal y, 
                          const qreal width, const qreal height)
{
  switch (type)
  {
