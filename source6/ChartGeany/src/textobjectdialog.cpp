  ...
  QDialog (parent), ui (new Ui::TextObjectDialog)
{
  ...
  ui->previewLabel->setStyleSheet (CGLiteral ("background-color : black; color : white;"));
...
QLabel *
TextObjectDialog::getLabel () Q_DECL_NOEXCEPT
{
...
void
TextObjectDialog::colorDialog_rejected () Q_DECL_NOEXCEPT
{
  raise ();
}
...
{
  ui->previewLabel->setText (CGLiteral (""));
  ui->textEdit->setText (CGLiteral (""));
